...
async def main():
    parser = argparse.ArgumentParser(description="Coffee Roaster BLE Interface")
    parser.add_argument("--dev", action="store_true", help="Run in development mode with CLI")
